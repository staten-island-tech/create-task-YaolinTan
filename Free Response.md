...
There is a click button in the code, when clicked, it will insert the child nodes of one of the DOM selectors and the word "paste"
...
There is a click button that when clicked will run the funtion resetHistory
